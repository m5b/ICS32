...
The following notes have been released to provide you with additional guidance on how to approach completing the TODO requirements for assignment 5.
...
1. We need to load an existing profile. So rather than generating a new keypair, we will import based on how store keys in our NaClProfile object (from a4):
...
And that's it. Most of what I have shared here is code you have already written. I am just providing you with a quick overview of one of many ways to go about implementing it.
