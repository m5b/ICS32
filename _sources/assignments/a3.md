...
Finally, so that we may accurately test your program, all of your API classes (**`OpenWeather`**, **`LastFM`**, and extra credit) must implement the following functions:
